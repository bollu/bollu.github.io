...
the prob. that the output of the game will be b, is bounded by \frac{1}{2} + \mu, where \mu
...
\frac{1}{2}, then he can repeatedly reapply the strategy some polynomial number
