...
\begin{itemize}
    ...
    \item $(\lim_{\epsilon \to 0} \frac{1}{\epsilon} \pushforward{\sigma_{-\epsilon}}(Y(\sigma_\epsilon(x))) - Y(x))^i =
        \frac{1}{\epsilon}(\mathbf Y^i + \epsilon(\mathbf X^i \partial_k \mathbf Y^k - \mathbf Y^k \partial_k \mathbf X^i) - Y^i)
            = \mathbf X^i \partial_k \mathbf Y^k - \mathbf Y^k \partial_k \mathbf X^i$
