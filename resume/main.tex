...
Since my teens, I’ve worked on functional programming.
At Tweag, I implemented WebAssembly GC and runtime for \textbf{Asterius}, a Haskell→Wasm compiler later merged into GHC.
I’m the \#2 contributor to Asterius and among the top 20 contributors to \textbf{Lean}, co-author of the \textit{Lean4 Metaprogramming Book}, and one of the top two contributors to its bitvector theory.
I developed much of the correctness theory for Lean’s bitblaster (\texttt{bv\_decide}).

\textbf{Compilers \& HPC:}
Deep experience in compilers and high-performance computing.
I contributed 121 patches to \textbf{Polly}, LLVM’s polyhedral loop optimizer, making me its \#3 contributor.
My work enabled GPU code generation for real-world climate models (e.g., COSMO).
I also mentored students via Google Summer of Code (2016).

\textbf{AI for Maths:}
My goal is scalable AI for theorem proving—since only search scales.
At Microsoft Research (2023), I applied RL to proof repair in \textbf{F*} (“Towards Neural Synthesis for SMT-Assisted Proof-Oriented Programming,” ICSE’25, best paper).
I also studied scaling decision procedures for symbolic problems such as geometry vs. neural approaches.
