...
\begin{itemize}
\item Top 20 contributors to the Lean theorem prover overall.
\item \#2 contributor to Lean's bitvector theory.
...
\textbf{Loop Optimization \& HPC:}
\begin{itemize}
\item Worked on Polly, LLVM's polyhedral loop optimizer.
\item 121 commits in Polly, and the \#3 contributor to the Polly. Added support for GPU code generation.
\item Mentored students for LLVM in Google Summer of Code (GSoC 2016).
\end{itemize}

\textbf{Compilers for Functional Languages:}
\begin{itemize}
...
\textbf{AI for Maths:}
\begin{itemize}
\item RL for proofs in the F* proof assistant @ Microsoft Research ("Towards neural synthesis for SMT-assisted proof-oriented programming"@ICSE 2025, best paper). \item Established stronger baselines for AI based geometric theorem proving.
\end{itemize}
