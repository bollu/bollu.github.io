...
\textbf{High Performance Computing (Loop Optimization) \& Compilers (LLVM, MLIR, Haskell, Lean):}
\begin{itemize}
...
\cventry{Mar-Dec '17}{ETH Zurich, Scalable Parallel Computing Lab}{Zurich, Switzerland}{Research Intern}{}{Worked on GPU code generation in Polly, a polyhedral loop optimizer for LLVM.}
