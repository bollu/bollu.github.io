...
\textbf{Compiler Verification (Lean) \& Static Analysis (LLVM/MLIR)}
\begin{itemize}
...
\textbf{Algorithms (SMT Solvers)}
\begin{itemize}
\item Published new, formally verified algorithms for deciding parametric bitvector theory.
\item Our \bvdecide{} solver placed 5th at SMT-COMP 2025 in the \qfbv{} division.
...
\textbf{High Performance Computing (Loop Optimization) \& Compilers (C++, LLVM, MLIR, Haskell, Lean):}
\begin{itemize}
\item \#3 Contributor to Polly, LLVM's polyhedral loop optimizer. 121 commits to Polly, 6000 LoC to LLVM, added support for Fortran GPU code generation.
...
\textbf{Software Engineering (C++, LLVM, Haskell, Lean):}
\begin{itemize}
\item \#3 Contributor to Polly, LLVM's polyhedral loop optimizer. 121 commits to Polly, 6000 LoC production quality C++ to LLVM,
  added support for Fortran GPU code generation.
\item Google Summer of Code Mentor for LLVM (2016).
\item \#2 contributor to Asterius, a Haskell $\to$ WebAssembly compiler. Over 5000 lines of JS, WASM, Haskell.
   Implemented a Haskell-style runtime on top of the WASM runtime. Contributions merged into Asterius, and eventually into GHC proper.
\item Primary Author of Lean's LLVM backend.
\end{itemize}
...
\section{Education}
\cventry{PhD in Comp. Science}{University of Cambridge}{}{}{}{(2024 - 2026 Summer (tentative))}.
\cventry{PhD in Comp. Science}{University of Edinburgh (\textit{moved to Cambridge})}{}{}{}{(2022 - 2024)}.
\cventry{Masters in Comp. Science}{International Institute of Information Technology Hyderabad India}{}{}{}{(2020 - 2021)}.
\cventry{B.Tech in Comp. Science}{International Institute of Information Technology Hyderabad India}{}{}{}{2015 - 2020}.

\section{Industry Research}
\cventry{Sep-Nov '24}{Amazon Web Services, Automated Reasoning Group}{Austin}{Research Intern}{}{Deciding memory (non)interference in \texttt{lnsym}, a Lean-based ARM symbolic simulator}
\cventry{Jul-Sep '23}{Microsoft Research}{Redmond}{Research Intern}{}{Retrieval Augmented theorem proving for the Fstar proof assistant.}
...
\cventry{May-Jul '19}{Tweag.io}{Paris, France}{Research Intern}{}{Re-implemented portions of GHC(Glasgow Haskell Compiler) runtime for \href{https://github.com/tweag/asterius/commits?author=bollu}{\texttt{Asterius} (link)}, a Haskell to WebAssembly compiler. Involved Haskell, C, and WebAssembly.}
...
\section{Academic Internships}
\cventry{Summer 2018}{ETH Zurich}{Zurich, Switzerland}{Research Intern}{}{Investigating formal verification of polyhedral compilation. \href{http://github.com/bollu/polyir}{\texttt{PolyIR (Link)}} is a formal specification of polyhedral programs.}
\cventry{Summer 2018}{Google Summer of Code}{Polly Labs}{Mentor}{}{Mentoring a project to enable Polly's loop optimisations into Chapel.}
  \cventry{Mar-Dec '17}{ETH Zurich (Scalable Parallel Computing)}{Zurich, Switzerland}{Research Intern}{}{Worked on GPU code generation in Polly, a polyhedral loop optimizer for LLVM.}
...
\cventry{Summer 2015}{Google Summer of Code 2015}{Google}{}{}{Worked on VisPy, a pure Python graphics library which uses OpenGL internally for performance. Successfully completed.}


\section{Publications}

\subsection{First Author Papers}
\cvitem{}{Sound and Complete Solving for Multi-Width Parametric Bitvectors via Principled Reductions: \textbf{Siddharth Bhat (1st)}, L\'eo Stefanesco, Tobias Grosser. OOPSLA 2026 (Under Review)}
...
\cvitem{}{Faults in Our Formal Benchmarking: Dataset Defects and Evaluation Failures in Lean Theorem Proving: Pawan Sasanka Ammanamanchi, \textit{Siddharth Bhat}, Stella Biderman. ICML 2026}
